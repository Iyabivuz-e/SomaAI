...
class TeacherProfileResponse(BaseModel):
    ...
    teacher_id: str = Field(..., description="Associated teacher ID") ## This initially will be the cookie that was generated by the backend for the teachers then be stored in the local storage on the frontend.
