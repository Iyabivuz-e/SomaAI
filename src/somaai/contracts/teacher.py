...
class TeacherProfileRequest(BaseModel):
    ...
    analogy_enabled: bool = Field(
        True, 
        description="Enable analogy explanations by default"
    )
    realworld_enabled: bool = Field(
        True, 
        description="Enable real-world context by default"
    )
...
class TeacherProfileResponse(BaseModel):
    ...
    realworld_enabled: bool = Field(..., description="Real-world context default setting")
